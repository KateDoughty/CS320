...
public class ContactServiceTest {
	...
	@BeforeEach
	void setUp() {
		contactId = "NOVE231963";
		firstNameTest = "Doctor";
		lastNameTest = "Who";
		phoneNumberTest = "0095475949";
		addressTest = "13 Bannerman Road";
		tooLongContactId = "00000000000";
		tooLongFirstName = "Sir Alistair Gordon";
		tooLongLastName = "Lethbridge-Stewart";
		tooLongPhoneNumber = "07700900461";
		tooShortPhoneNumber = "1963";
		tooLongAddress = "13 Bannerman Road Ealing London UK";
	}

	@Test
	  void newContactServiceTest() {
